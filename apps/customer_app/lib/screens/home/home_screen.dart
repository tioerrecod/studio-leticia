                        ...
                        errorBuilder: (_, __, ___) => Container(
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [SLColors.sage.withValues(alpha: 0.4), SLColors.background],
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [
                              Colors.transparent,
                              Colors.transparent,
                              SLColors.background.withValues(alpha: 0.3),
                              SLColors.background.withValues(alpha: 0.85),
                            ],
                            begin: Alignment.topCenter,
                            end: Alignment.bottomCenter,
                          ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SLExperiencePass(
                        ...
                        serviceName: homeData.nextAppointment!.serviceName ?? 'Serviço',
                        professionalName: homeData.nextAppointment!.professional?.name ?? 'Profissional',
                        duration: '${homeData.nextAppointment!.serviceDuration ?? 0} min',
                        onTap: () {},
                      ),
                    ],
                  ),
